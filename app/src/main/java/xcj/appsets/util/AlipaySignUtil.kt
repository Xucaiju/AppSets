...
import xcj.appsets.javamethod.AlipayBase64
import java.security.KeyFactory
import java.security.Signature
import java.security.spec.PKCS8EncodedKeySpec


object AlipaySignUtil {
    ...
    fun sign(
        ...
        try {
            ...
            val priPKCS8 = PKCS8EncodedKeySpec(AlipayBase64.decode(privateKey))
            val keyf = KeyFactory.getInstance(ALGORITHM)
            val priKey = keyf.generatePrivate(priPKCS8)
            val signature = Signature.getInstance(getAlgorithms(rsa2))

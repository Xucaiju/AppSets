...
import xcj.appsets.extendedclass.UserProfileEditBottomSheetFragment
...
class SettingsActivity : BaseActivity() {
        ...
        override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
            ...
            localeList.setOnPreferenceChangeListener { preference, newValue ->
                ...
                if (TextUtil.isEmpty(choice)) {
                    ...
                    getAllActivitys(requireContext())?.let {
                        for (activity in it) {
                            activity.recreate()
                        }
                    }
    ...
    fun updateMyProfile(view: View) {
        ...
        val userProfileEditBottomSheetFragment = UserProfileEditBottomSheetFragment()
